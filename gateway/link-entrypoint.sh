...
iptables -t nat -A POSTROUTING -o link0 -p tcp --dport 80 -j SNAT --to-source 10.0.0.1
iptables -t nat -A POSTROUTING -o link0 -p tcp --dport 443 -j SNAT --to-source 10.0.0.1
